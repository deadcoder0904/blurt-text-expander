export const ICON_EDIT =
  '<svg viewBox="0 0 24 24" fill="currentColor" class="size-5"><path d="M20.989 4.285 19.64 2.93c-1.236-1.241-3.146-1.241-4.382 0L13.011 5.3l5.73 5.754 2.36-2.37A3.1 3.1 0 0 0 22 6.542c0-.79-.45-1.693-1.011-2.257m-4.719 6.657L11.775 6.43 2.9 15.343c-.563.564-.9 1.354-.9 2.256v3.498c0 .452.337.903.899.903h3.595c.787 0 1.573-.338 2.248-.903l8.876-8.914z"/></svg>'
